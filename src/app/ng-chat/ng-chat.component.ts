...
export class NgChat implements OnInit, IChatController {
    ...
    private bootstrapChat(): void
    {
        ...
        if (this.adapter != null && this.userId != null)
        {
            try
            {
                ...
                CommonService.messageReceivedHandler = (user, msg) => this.onMessageReceived(user, msg);
                CommonService.friendsListChangedHandler = (users) => this.onFriendsListChanged(users);
    ...
    private onMessageReceived(user: User, message: Message)
    {
        if (user && message)
        {
            ...
            // comment this line to open last send message
