...
@Component({
  selector: 'app-playlist-lesson-queue',
  templateUrl: './playlist-lesson-queue.component.html',
  styleUrls: ['./playlist-lesson-queue.component.scss']
})
export class PlaylistLessonQueueComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private mScrollbarService: MalihuScrollbarService, private playlistService: PlaylistService, private _ngZone: NgZone) {
  ...
  bindNoteFlight() {
    ...
    if (this.playlistService.LessonModel.LessonQueue != undefined) {
  ...
  lessonQueueCallback(lessonQueueJsonObject) {
    ...
    this.playlistService.libraryNodes = nodelist;
    this.playlistService.libraryHistoryNodes = nodelist;
  }
